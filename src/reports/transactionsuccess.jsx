...
export default function App() {
  ...
  const data = [
    { id: "A", value: 100, type: "Failed Transaction", color: "#FF7682" },
    { id: "B", value: 85, type: "Successful Transactions", color: "#63FFAC" },
  ...
  return (
    <div className="W-[50%] mx-auto p-6  rounded-xl shadow-sm border-[#E4E4E4] bg-[#F6F6F6]" style={{boxShadow: "0px 16px 30px 0px #585C5F29"}}>
      <div className="flex justify-between items-start mb-2">
        <h1 className="text-xl font-bold">Transaction Success Rate</h1>
...
<select
      ...
      <p className="text-gray-600 text-lg mb-8">Shows percentage of successful vs. failed transactions </p>
<div className="w-full h-max flex items-center gap-8">
      <div className="w-[14rem] h-60">
  <ResponsiveContainer width="100%" height="100%">
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-x-[3.5rem] pr-8">
  {data.map((item, index) => (
    <div key={index} className="w-full">
      <div className="flex items-center gap-2 w-full min-h-[10px] p-2">
        ...
        />
        <span className="text-gray-700 text-[15px] whitespace-nowrap">{item.type}</span>
        <span className="text-gray-700 text-[15px] whitespace-nowrap ml-2">10%</span>
      </div>
    </div>
  ))}
</div>
