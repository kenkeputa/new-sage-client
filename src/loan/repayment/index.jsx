...
function Repayment() {
    ...
    <div className="flex flex-col h-[125px] w-[267.5px] bg-[#831AD31A] rounded-[0.5rem] border-[1px] border-[#E4E4E4] px-[16px] py-[6px]" style={{boxShadow: "0px 16px 30px 0px #585C5F29"}}>
                ...
                <div className="flex flex-col h-[120px] w-[267.5px] bg-[#B5E45E1A] rounded-[0.5rem] border-[1px] border-[#E4E4E4] px-[16px] py-[6px]" style={{boxShadow: "0px 16px 30px 0px #585C5F29"}}>
                    ...
                    <path d="M24.2844 14.4338C22.1686 10.7561 19.1351 8.75818 15.7232 8.0813C16.7929 7.36384 18.0929 6.10827 19.3747 3.86553C19.7164 3.26852 19.537 2.50915 18.9649 2.12685C18.8719 2.06401 16.6292 0.597656 13.0013 0.597656C9.37337 0.597656 7.13194 2.06401 7.03768 2.12685C6.46423 2.50915 6.28617 3.26852 6.62788 3.86553C7.90964 6.10827 9.20972 7.36514 10.2794 8.0813C6.86617 8.75818 3.83265 10.7548 1.71821 14.4338C0.102606 17.2434 -0.394907 20.3437 0.316013 23.1638C1.43411 27.5943 5.10916 29.4011 13 29.4011C20.8908 29.4011 24.5672 27.5943 25.684 23.1651C26.3949 20.345 25.8987 17.2447 24.2844 14.4338Z" fill="#87BF20"/>
                    </svg>
                    </div>
    ...
    index === 1 ?
    <OngoingActivity datatable={main[0]?.record} /> : 
    index === 2 ? <PaidActivity datatable={main[0]?.record} /> : <ReminderActivity />}
